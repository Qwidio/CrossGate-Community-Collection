    <footer>
        <div class="footer-group">
            <img src="img/prsvlogolight.png" alt="" class="footer_logo">
            <p class="legal">© 2026 POROSIVE - All right reserved. All trademarks are property of their respective owners.</p>
