...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2026 at 12:14 PM
...
CREATE TABLE `badges` (
  ...
  `icon` varchar(1000) NOT NULL DEFAULT '''empty'''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('06012026dda58441fcfb9daf135a5d4f', '29052026fc5fd02f31b3d6cb4946cbbb', 'qwidio', 'qwidio', 'Racism and discrimination is not tolerated here and generally anywhere else', '06/01/2026', 0, '', 0);
...
CREATE TABLE `forums` (
  ...
  `ForumAttachment` text NOT NULL DEFAULT '\'empty\''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('29052026fc5fd02f31b3d6cb4946cbbb', 'welcome message & friendly reminder', 'qwidio', 'CrossGateBugnFeedback-2362025', '05/29/2026', 'Regardless where you\'re coming from, all of you are welcomed here. I cannot ask more than to keep yourself mostly friendly here aight.', 'Publics', 'TRUE', 'empty.png');
...
(1, 'qwidio', '$2y$10$Lk/VW4y9C4eRrgzXrEIGm.d0CKNWwUhdcAcdooQBLQDl.qojAqbR2', 'founder', 'POROSIVE', 'approved');
...
CREATE TABLE `libslist` (
  ...
  `cltNumbs` int(11) NOT NULL DEFAULT 0,
  ...
  `downloadDisabled` tinyint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `libslist` (`libsIds`, `libsPublisher`, `libsVT`, `libsAttachs`, `libsBanners`, `libsTitles`, `libsDesc`, `repolink`, `libsMD`, `extlink`, `addedDates`, `cltNumbs`, `libsType`, `libsCategorys`, `fdrLibs`, `rollbacks`, `detailData`, `recspecs`, `libsForum`, `devstats`, `devstatdesc`, `downloadDisabled`, `libsState`) VALUES
('NIIE393a570e02062026', 'POROSIVE', '', 'NIIE393a570e02062026_1781874301_86737ff0ed6038c4_NIElogotrsp.png', '[\"1_1780357641_0c238f46e42f2d87_NIEbanner.png\"]', 'Nameless Assembly', 'Work in progress game', 'https://github.com/POROSIVE/Nameless-Assembly', 'https://raw.githubusercontent.com/Qwidio/CrossGate-Community-Collection/main/README.md', '{\"official website\":\"https://www.porosive.com/projects\"}', '02/06/2026', 1, 'game', 'GamesNugg', '1785084210_NIIE393a570e02062026_b5020ecd_NamelessLow.zip', '1785084210_NIIE393a570e02062026_b5020ecd_NamelessLow.zip', '{\"fdrLibs\":{\"executables\":\"NamelessLow.exe\",\"uninst\":\"none\",\"ver\":\"0.1.0\"},\"rollbacks\":{\"executables\":\"NamelessLow.exe\",\"uninst\":\"none\",\"ver\":\"0.1.0\"},\"theme\":\"dark\"}', '{\"cpu\":\"2 core/2 thread\",\"ram\":\"4GB DDR4\",\"gpu\":\"GTX 960 2GB/ RX 460 2GB\",\"win\":\"10 or Newer\",\"linux\":\"not supported\",\"mac\":\"not supported\"}', 'NIIE_topic_402e931d', 'earlyaccess', 'The game will be have a select people to play and test the game, Hit up if you want to join early tester program', 0, 'publics');
...
(1, 'POROSIVE', 'POROSIVE STUDIO', 'Lurking in hidden rows', '12/12/2025', 'qwidio', '[\"qwidio\"]', '1782035651_f67a6221eb44cb2f_prsvlogobglight.png', 'porosive.png', '[{\"site\":\"porosive.com\",\"yt\":\"www.youtube.com/@porosive\"}]');
...
('clientCrgs', 'clientpromote.png', '[]', 'client', 'homepage', '6/6/2026', 'active'),
('default', 'default.png', '[]', 'other', 'Groups/', '6/6/2026', 'active');
...
('qwidio', '1782035884_5a4f290b1d2b698b_cgcclogo.png', 'qwidio', 'the first boi in here', '19/12/2025', '{\"1\":\"24/3/2026 01:23\"}', 'Offline', '{\"marked\":{\"NIIE393a570e02062026\":{\"libsIds\":\"NIIE393a570e02062026\",\"Hours\":0,\"lastLog\":\"3/7/2026 11:12\"}},\"private\":false,\"favbadge\":\"none\",\"themes\":\"5\",\"borders\":\"2\"}', 'inactive');
...
CREATE TABLE `topics` (
  ...
  `topicAttachs` text NOT NULL DEFAULT '\'empty\'',
...
('NIIE_topic_402e931d', 'Nameless-Assembly announcement', '02/06/2026', 'Nameless-Assembly announcement topics', 'Publics', 'empty.png', 'publisherOnly'),
...
INSERT INTO `user` (`UserID`, `profileTags`, `username`, `password`, `Email`, `userState`, `activation_token_hash`, `activation_expires`, `activated_at`) VALUES
(99, 'qwidio', 'qwidio', '$2y$10$Lk/VW4y9C4eRrgzXrEIGm.d0CKNWwUhdcAcdooQBLQDl.qojAqbR2', 'qwidio@gmail.com', 'approved', NULL, NULL, NULL);
...
--
ALTER TABLE `badgegroup`
  MODIFY `bgIds` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `groupaccess`
--
ALTER TABLE `groupaccess`
  MODIFY `ga_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `groupsession`
  MODIFY `gs_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `sessionlogs`
  MODIFY `logids` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
