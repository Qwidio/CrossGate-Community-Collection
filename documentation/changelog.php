...
<head>
    ...
    <title>Changelog / CGCC</title>
    <!-- doesn't get replaced with proper one because I cannot be bothered to do it -->
    <style>
        /* Positioning & Layout */
        .top-95px { top: 95px; }
        .flex-1 { flex: 1; }
    ...
    <main class="sideMg topMg-10 bottomMg-s10 w75 flex gap10">
        <aside class="pos-s t10 pad-s-s minw10 w20p maxw20 maxh80 gap10 ovh-s">
            <div class="bottomMg-s10 pad-s-v flex fld border-purple-b gap5">
                <a href="#intro" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">Introduction</a>
            </div>
            <div class="bottomMg-s10 pad-s-v flex fld border-purple-b gap5">
                <p class="leftMg-s10 txt-b c-lightpurple">June</p>
                <a href="#26j25" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">25th</a>
                <a href="#26j18t19" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">18th - 19th</a>
                <a href="#26j12t13" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">12th - 13th</a>
                <a href="#26j1t4" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">1st - 4th</a>
            </div>
            <div class="bottomMg-s10 pad-s-v flex fld border-purple-b gap5">
                <p class="leftMg-s10 txt-b c-lightpurple">May</p>
                <a href="#26m16t31" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">16th - 31st</a>
                <a href="#26m1t15" class="posr pad-s bora-s txt-s hover-white hover-pad-l16">1st - 15th</a>
            </div>
        </aside>

        <section class="posr w75p flex fld gap">
            <div class="posr pad-n bg-thin-gray border-purple bora-m box-shad-black-1">
                <h2 class="pad-s-v txt-l c-lightpurple border-purple-b">ChangeLogs</h2>
                <p class="pad-n-v txt-n">Specifically made to address my forgetfulness by a bit, basically a more organized version of the journals. Note: the date written for update before June/2026 are estimated date +1 to 10 days</p>
            </div>

            <div class="posr pad-n bg-thin-gray border-purple bora-m box-shad-black-1">
                <h2 class="pad-s-v txt-l c-lightpurple border-purple-b">June / 2026</h2>
                
                <div class="topMg-s10 pad-s-v flex fld gap10" id="26j25">
                    <h3 class="posr pad-s-v txt-b c-blue">26th / Bug Fix & Improvement</h3>
                    <p class="txt-n">Fixed image upload issues. Replacing 'time()' function that causes path finding issues when uploading images with the Unix Converted Date as the replacement</p>
                    <p class="txt-n">Fixed forum image routing. Replaced 'ArchFiles' folder to 'img', the images uploaded to forum now saved inside specific forum directory inside the 'img' folder</p>
                    <p class="txt-n">API's now separated by it's method, example are `reauth.php` for verifying session and `getcollection.php` for retrieving collection info. For more info please see the References at  <a href="api.php" class="posr c-orange hover-text-blue">the documentation</a></p>
                </div>
                <div class="topMg-s10 pad-s-v flex fld gap10 border-top-1-subtle-dark" id="26j18t19">
                    <h3 class="posr pad-s-v txt-b c-blue">19th / MarkOut Overhaul</h3>
                    <p class="txt-n">Reworked MarkOut UI, New detail page for MarkedOut Collection, and Ability to removed a collection from the MarkedOut</p>
                    <p class="txt-n">Updated styling class & Fixed download API auth check</p>
                </div>
                <div class="topMg-s10 pad-s-v flex fld gap10 border-top-1-subtle-dark">
                    <h3 class="posr pad-s-v txt-b c-blue">18th / Adding API detail</h3>
                    <p class="txt-n">API panel now include extra detail about the API in Groups management dashboard</p>
                </div>
                
                <div class="topMg-s10 pad-s-v flex fld gap10 border-top-1-subtle-dark" id="26j12t13">
                    <h3 class="posr pad-s-v txt-b c-blue">13th / changelog created</h3>
                    <p class="txt-n">The reason? look at this page introduction, no currently it isn't dynamically retrieved from the database but this haven't get finalized yet.</p>
                </div>
                
                <div class="topMg-s10 pad-s-v flex fld gap10 border-top-1-subtle-dark">
                    <h3 class="posr pad-s-v txt-b c-blue">12th / the API auth and download Implemented</h3>
                    <p class="txt-n">
                        ...
                        <br>
                        download api does work but it currently isn't fully validated to be secure. more detail on <a href="api.php" class="posr c-orange hover-text-blue">the documentation</a>
                    </p>
                </div>

                <div class="topMg-s10 pad-s-v flex fld gap10 border-top-1-subtle-dark" id="26j1t4">
                    <h3 class="posr pad-s-v txt-b c-blue">1st - 4th / fixing the community management tab 403 issue</h3>
                    <p class="txt-n">The word "announce" were specifically being blocked to be used as directive and after changing the file names the site works as you might see in this changelog page you're currently visiting.</p>
                </div>
            </div>
            <div class="posr pad-n bg-thin-gray border-purple bora-m box-shad-black-1" id="26m16t31">
                <h2 class="pad-s-v txt-l c-lightpurple border-purple-b">May / 2026</h2>
                
                <div class="topMg-s10 pad-s-v flex fld gap10">
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / report implementents</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / settings & consent</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / implemented profile picture</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / session manager UI update</h3>
                    <p class="txt-n">
                    ...
                    <div class="pad-s-s flex acjc bg-1 border-purple bora-s">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / updated collection views</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">16th - 31st / collection file manager</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">8th - 15th / Community Management</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue" id="26m1t15">8th - 15th / collection publishing</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">7th - 15th / Invitation notification</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">7th - 15th / groups-flow access system</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">7th - 15th / groups-flow auth sessions</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">2nd - 15th / groups-flow</h3>
                    <p class="txt-n">
                    ...
                    <h3 class="posr pad-s-v txt-b c-blue">1st - 15th / session system</h3>
