        ...
        <div id="settings" class="posr sideMg w100vh minw40 maxw100 bg-prf-2 h100 flex fld bg-def-1 ovh-s">
            ...
            <div class="posr topMg-s10 w100p flex fld gap10">
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Profile Picture</label>
                ...
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Profile Borders</label>
                    <a class="posr leftMg pad-n-s pad-m-v minw10 txtc bg-def-2 hover-text-blue hover-border-white border-1 bora-s" onclick="uniDisplaySwitch('profileborder');">Change</a>
                </div>
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Profile Bio</label>
                ...
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Favorite Badge</label>
                ...
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Background theme</label>
                ...
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Privacy</label>
                ...
                <div class="posr sideMg w95p pad-n-s flex acjc">
                    <label for="settingoptions">Change Password</label>
                    <a class="posr leftMg pad-n-s pad-m-v minw10 txtc bg-def-2 hover-text-blue hover-border-white border-1 bora-s" href="connect_it/connect_reset.php?state=reset">Reset</a>
                </div>
            </div>
    ...
    <dialog id="bgtheme" class="posf c0 w50 w100vh minw40 maxw100 h100 dp-none fld bg-def-1 ovh-s border-none z999">
        ...
        <div id="bgDisplay" class="posr topMg-s10 sideMg w95p h40 flex <?php echo $themes["bg"];?> box-shad-black-1 bora-s z2">
            ...
            <div class="posr vertiMg pad-n-v pad-sr w50p h80p flex fld z4">
                <h2 class="posr topMg w100p txt-l <?php echo $themes["color"];?>">...</h2>
                <div class="posr w100p flex">
                    <p class="posr rightMg txt-s <?php echo $themes["color"];?>">_____</p>
                </div>
        ...
        <form class="posr w100p flexblurbg flex fld gap10" name="favbadgeform" action="processes/bionic.php" method="post" enctype="multipart/form-data">
            ...
            <div class="posr topMg-s10 sideMg pad-s w95p flex acjc gap10 bg-def-1 box-shad-white-1 bora-s">
                ...
                <div class="posr flex fld acjc bg-half-gray border-none bora-s ovh">
                    <img class="posr icon-s bg-prf-paper blurbg border-none ovh">
                    <input class="posa" type="checkbox" name="themescheckbox" id="themesCheckbox" value="5">
                </div>
            </div>
...
<!-- edit profile border -->
    <dialog id="profileborder" class="posf c0 w50 w100vh minw40 maxw100 h100 dp-none fld bg-def-1 ovh-s border-none z999">
        <div class="posr w100p flexblurbg flex"><h2 class="rightMg pad-n txt-b">Change Border</h2><p class="pad-n txt-b hover-red" onclick="uniDisplaySwitch('profileborder')">X</p></div>
        <div class="posr topMg-s10 sideMg w95p h40 flex bg-half-gray box-shad-black-1 bora-s z2">
            <div class="posr vertiMg r1-1 w20p flex z3">
        <?php
        if (empty($pfAttachs) || $pfAttachs === "empty") {
        ?>
                <img  id="preview" src="" class="posr autoMg r1-1 h80p flex acjc bgc-white containfit bora-s z4">
        <?php
        } else {
        ?>
        <img src="zprpic/<?php echo $Tags . "/" . $pfAttachs;?>" alt="<?php echo $Names;?>" class="posr autoMg r1-1 h80p flex acjc bgc-white containfit bora-s z4">
        <?php
        };
        ...
        <form class="posr w100p flexblurbg flex fld gap10" name="favbadgeform" action="processes/bionic.php" method="post" enctype="multipart/form-data">
            <h2 id="accentDisplay" class="posr topMg-s10 sideMg pad-s w95p box-shad-black-1 bora-s txt-n txtc">Tick one of the checkbox below to change border</h2>
            <div class="posr sideMg pad-n-v pad-s-s w95p flex acjc gap10 bg-def-1 box-shad-white-1 bora-s">
                <div class="posr flex fld acjc bg-half-gray border-none bora-s ovh">
                    <img style="height: calc(80% + 20px);" class="posr icon-s border-none bg-white ovh">
                    <input class="posa" type="checkbox" name="borderscheckbox" id="bordersCheckbox" value="0">
                </div>
                <div class="posr flex fld acjc bg-half-gray border-none bora-s ovh">
                    <img src="img/borderpurple.png" style="height: calc(80% + 20px);" class="posr icon-s border-none bg-white ovh">
                    <input class="posa" type="checkbox" name="borderscheckbox" id="bordersCheckbox" value="1">
                </div>
                <div class="posr flex fld acjc bg-half-gray border-none bora-s ovh">
                    <img src="img/border-paper.png" style="height: calc(80% + 20px);" class="posr icon-s border-none bg-white ovh">
                    <input class="posa" type="checkbox" name="borderscheckbox" id="bordersCheckbox" value="2">
                </div>
            </div>
            <input class="hiddeninp" type="text" name="request" value="selectBorders" hidden readonly>
            <input class="hiddeninp" type="text" name="selectedBorders" id="selectedBorders" hidden readonly>
            <div class="posr topMg-s10 sideMg pad-n-s w95p flex">
                <input class="posr leftMg pad-m-v pad-n-s minw10 txt-n c-black bgc-gold" type="submit" name="submit" value="Save Changes">
            </div>
        </form>
...
<!-- edit bio -->
    ...
    <script type="text/javascript">
        ...
        function uncheckBorders() {
            var checkboxes = document.querySelectorAll('#bordersCheckbox');
            for (var i = 0, length = checkboxes.length; i < length; i++) {
                checkboxes[i].checked = false;
            }
        }
        function bordersChecked() {
            uncheckBorders();
            this.checked = true;
            var getBorders = this.value;
            document.getElementById('selectedBorders').value = getBorders;
            Selecting = true;
        }
        ...
        function themesChecked() {
            ...
            if (themes === "2") {
                ...
                document.getElementById('bgDisplay').style.background = "#f5eed2";
                document.getElementById('accentDisplay').style.background = "#ece0bd";
                document.getElementById('accentDisplay').style.color = "#000000";
            } else {
        ...
        function init() {
            ...
            var checkboxes = document.querySelectorAll('#bordersCheckbox');
            for (var i = 0, length = checkboxes.length; i < length; i++) {
                checkboxes[i].addEventListener('click', bordersChecked);
            }
        }
        init();
    </script>
